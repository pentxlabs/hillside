      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            <h3>Hill Side</h3>
            <p>
              Your one-stop destination for vehicle services, entertainment, and
              hospitality.
            </p>
          </div>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p>
              &copy; {new Date().getFullYear()} Hill Side. All rights reserved.
              | Developed by Pent X
            </p>
            <div className="footer-bottom-social">
              ...
              <a
                href="https://pentxlabs.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Website"
              >
